...
4. Mandelbrot quería mapear qué áreas son estables y cuales inestables para ver si existe algún patrón, y también si son simétricas o no. Lo que Mandelbrot encontró es lo siguiente: **áreas en el sector negro son áreas estables y las áreas de colores son no estables**.
